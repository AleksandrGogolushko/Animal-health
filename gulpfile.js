...
//all files
const cssFiles = ["./src/css/work-file/*.css"];
const finalCssFile = ["./src/css/style.css"]
const jsFiles = ["./src/js/*.js"];
const images = ["./src/image/*"];
const scssFiles = ["./src/scss/*.scss"]
const finalJSfile = ["./src/js/app/main.js"]
...
// concat js file to main.js
 function concatJsFile()  {
...
//CSS
gulp.task('concatCssFile',concatCssFile);
gulp.task("styles",styles);
//JS
gulp.task('concatJsFile',concatJsFile);
...
gulp.task("build",gulp.series(clean,scssToCss,concatCssFile,concatJsFile,copyLib,  gulp.parallel(index,styles,scripts,image)));